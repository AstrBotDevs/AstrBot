...
3. 在**机器人卡片**中点击 “查看二维码” 按钮，会弹出二维码对话框。（点击保存之后可能需要等 5 到 10 秒左右才会出现这个按钮）。若此按钮迟迟未出现，且平台日志内显示No module named 'qrcode'类报错，则需要点击平台日志的右上角“安装Pip库”，随后在库名内输入 qrcode 并点击安装，安装成功后再回到**机器人卡片**的个人微信配置界面点击一次保存即可。
