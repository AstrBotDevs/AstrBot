...
Manage runtime sandboxes and execute sandbox operations.
...
Access system status and administrative system operations.
...
Manage LLM tools, commands, and tool permissions.
