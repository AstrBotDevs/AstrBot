...
| `mcp` | Manage MCP servers and inspect server capabilities | `GET/POST /api/v1/mcp/servers`, `GET /api/v1/mcp/prompts`, `POST /api/v1/mcp/prompts/preview`, `PATCH /api/v1/mcp/servers/{server_name}/enabled`, `POST /api/v1/mcp/providers/modelscope/sync` |
...
- `POST /api/v1/mcp/prompts/preview`: safely resolve a Prompt without starting a chat or executing tools
