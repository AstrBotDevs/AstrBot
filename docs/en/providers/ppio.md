...
Open the AstrBot dashboard → Providers page, click **Add Provider**, find and click `PPIO Cloud` (requires version >= 3.5.10; older versions are also supported, see below).
...
> [!TIP]
> If you are using an older version of AstrBot (< 3.5.10), open the AstrBot dashboard → Providers page, click **Add Provider**, find `OpenAI`, and click to enter.
