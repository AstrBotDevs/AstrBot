...
from .xxxbot_event import XXXBotPlatformEvent
...
@register_platform_adapter("wechat-xxxbot", "基于 wechat-xxxbot 的 Wechat 适配器")
class WeChatXXXBotPlatformAdapter(Platform):
    def __init__(
    ...
    async def send_by_session(
        ...
        await XXXBotPlatformEvent.send_with_client(
            message_chain, to_wxid, self.bot_wxid, self.client
        )
    ...
    def meta(self) -> PlatformMetadata:
        return PlatformMetadata(
            name="wechat-xxxbot",
            description="基于 wechat-xxxbot 的 Wechat 适配器",
    ...
    async def terminate(self):
        ...
        try:
            ...
            pass
        logger.info("wechat-xxxbot 适配器已被优雅地关闭。")
    ...
    async def handle_msg(self, message: AstrBotMessage):
        ...
        message_event = XXXBotPlatformEvent(
    ...
    def get_client(self) -> XXXBotClient:
        return self.client
