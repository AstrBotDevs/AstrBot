...
class TemplateManager:
    ...
    def __init__(self):
        ...
        self.template_dir = os.path.join(get_astrbot_path(), "astrbot", "core", "utils", "t2i", "template")
        self.backup_template_path = os.path.join(self.template_dir, "default_template.html.bak")
        # 确保模板目录存在
    ...
    def backup_default_template_if_not_exist(self):
        ...
        if not os.path.exists(self.backup_template_path) and os.path.exists(default_path):
