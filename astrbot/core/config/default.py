...
DEFAULT_CONFIG = {
    ...
    "wake_prefix": ["/"],
    "log_level": "INFO",
    "log_colors": "36,1;32,1;33,31,1;31",
            ...
            "system": {
                ...
                "items": {
                    ...
                    "log_colors": {
                        "description": "日志颜色设置",
                        "type": "string",
                        "hint": "可自定义的日志颜色设置，使用ANSI转义序列的颜色表示，分别表示DEBUG,INFO,WARNING,ERROR,CRITICAL日志的颜色，使用半角逗号分隔，解析失败时AstrBot将会使用默认设置。（基本格式：(是否加粗);(颜色编号)例如：“1;32”表示加粗的绿色）",
                    },
