        ...
        "metadata": {
            "provider": {
                ...
                "config_template": {
                    ...
                    "火山引擎_TTS(音频生成API)": {
                        "hint": "provider_group.provider.volcengine_tts_v3.hint",
                        "id": "volcengine_tts_v3",
                        "type": "volcengine_tts_v3",
                        "provider": "volcengine",
                        "provider_type": "text_to_speech",
                        "enable": False,
                        "api_key": "",
                        "api_base": "https://openspeech.bytedance.com/api/v3/tts/create",
                        "model": "seed-audio-1.0",
                        "volcengine_v3_speaker": "",
                        "volcengine_v3_format": "mp3",
                        "volcengine_v3_sample_rate": 48000,
                        "volcengine_v3_speech_rate": 0,
                        "volcengine_v3_loudness_rate": 0,
                        "volcengine_v3_pitch_rate": 0,
                        "timeout": 300,
                        "proxy": "",
                    },
                    "Gemini TTS": {
                ...
                "items": {
                    ...
                    "volcengine_v3_speaker": {
                        "type": "string",
                        "description": "火山引擎音色(Speaker)",
                        "hint": "音频生成 API 的音色 ID。留空时不发送音色参考，由服务端根据文本提示生成音频。",
                    },
                    "volcengine_v3_format": {
                        "type": "string",
                        "description": "音频输出格式",
                        "options": ["wav", "mp3", "pcm", "ogg_opus"],
                        "hint": "支持 wav、mp3、pcm 和 ogg_opus；AstrBot 预设使用 mp3。",
                    },
                    "volcengine_v3_sample_rate": {
                        "type": "int",
                        "description": "采样率",
                        "options": [8000, 16000, 24000, 32000, 44100, 48000],
                        "hint": "支持 8000、16000、24000、32000、44100 和 48000 Hz；AstrBot 预设使用 48000 Hz。",
                    },
                    "volcengine_v3_speech_rate": {
                        "type": "int",
                        "description": "语速",
                        "hint": "范围 -50 到 100；-50 为 0.5 倍速，100 为 2 倍速，0 表示不调整。",
                        "slider": {"min": -50, "max": 100, "step": 1},
                    },
                    "volcengine_v3_loudness_rate": {
                        "type": "int",
                        "description": "音量",
                        "hint": "范围 -50 到 100；-50 为 0.5 倍音量，100 为 2 倍音量，0 表示不调整。",
                        "slider": {"min": -50, "max": 100, "step": 1},
                    },
                    "volcengine_v3_pitch_rate": {
                        "type": "int",
                        "description": "音调",
                        "hint": "范围 -12 到 12，0 表示不调整音调。",
                        "slider": {"min": -12, "max": 12, "step": 1},
                    },
                    "azure_tts_voice": {
                        "type": "string",
                        "description": "音色设置",
