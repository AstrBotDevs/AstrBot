            ...
            "provider": {
                ...
                "config_template": {
                    ...
                    "OpenAI Embedding": {
                        ...
                        "embedding_max_requests_per_minute": 120,
                ...
                "items": {
                    ...
                    "embedding_max_requests_per_minute": {
                        "description": "Embedding 每分钟最大请求数",
                        "type": "int",
                        "hint": "限制同一 Embedding Provider 的批量向量化请求速率。设置为 0 表示不限制；远程 API 建议按服务商限额填写。",
                    },
                    "embedding_rate_limit_cooldown": {
                        "description": "Embedding 限速冷却上限（秒）",
                        "type": "int",
                        "hint": "当 Embedding API 返回 Retry-After 或限速错误时，同一 Provider 后续请求的最大等待秒数。",
                    },
                    "volcengine_cluster": {
                        "type": "string",
                        "description": "火山引擎集群",
