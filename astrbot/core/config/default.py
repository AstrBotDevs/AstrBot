        ...
        "metadata": {
            "provider": {
                ...
                "items": {
                    ...
                    "xai_web_search_config": {
                        "description": "xAI Web Search 工具",
                        "type": "object",
                        "hint": "xAI Responses 的网页搜索工具配置。",
                        "condition": {"type": "xai_responses"},
                        "items": {
                            "enabled": {
                            ...
                            "allowed_domains": {
                                ...
                                "type": "list",
                                "items": {"type": "string"},
                                "hint": "仅搜索这些域名；不可与 excluded_domains 同时设置。",
                            },
                            "excluded_domains": {
                                "description": "排除搜索的域名",
                                "type": "list",
                                "items": {"type": "string"},
                                "hint": "排除这些域名；不可与 allowed_domains 同时设置。",
                            },
                    ...
                    "xai_x_search_config": {
                        "description": "xAI X Search 工具",
                        "type": "object",
                        "hint": "xAI Responses 的 X/Twitter 搜索工具配置。",
                        "condition": {"type": "xai_responses"},
                        "items": {
                            "enabled": {
                            ...
                            "allowed_x_handles": {
                                ...
                                "type": "list",
                                "items": {"type": "string"},
                                "hint": "仅搜索这些 X 账号，不需要填写 @。",
                            },
                            "excluded_x_handles": {
                                "description": "排除搜索的 X 账号",
                                "type": "list",
                                "items": {"type": "string"},
                                "hint": "排除这些 X 账号，不需要填写 @。",
                            },
                            "enable_image_understanding": {
                                "description": "启用图片理解",
                                "type": "bool",
                    ...
                    "anth_thinking_config": {
                        ...
                        "items": {
                            "type": {
                                ...
                                "type": "string",
                                "options": ["", "adaptive"],
                                "hint": "设为 'adaptive' 以启用自适应/兼容思考控制。是否推荐取决于具体提供商与模型，例如 Opus 4.6+、Sonnet 4.6+ 与 DeepSeek V4。",
                            },
                            "budget": {
                                "description": "思考预算",
                                "type": "int",
                                "hint": "Anthropic thinking.budget_tokens 参数，需 >= 1024。不同提供商兼容性不同：例如 DeepSeek Anthropic 会忽略该字段，而 Opus 4.6 / Sonnet 4.6 已弃用。",
                            },
                            "effort": {
                                "description": "思考深度",
                                "type": "string",
                                "options": ["", "low", "medium", "high", "max"],
                                "hint": "type 为 'adaptive' 时控制思考深度。支持值取决于提供商与模型；DeepSeek V4 与 Opus 4.6 都支持 'max'。",
                            },
                        },
                    },
                    "max_tokens": {
                    ...
                    "model": {
                        "description": "模型 ID",
                        "type": "string",
                        "hint": "模型名称，如 gpt-4o-mini, deepseek-v4-flash, deepseek-v4-pro。",
                    },
                    "max_context_tokens": {
