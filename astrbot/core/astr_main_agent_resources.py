...
from astrbot.core.tools.prompts import TOOL_CALL_PROMPT, TOOL_CALL_PROMPT_LAZY_LOAD_MODE, LLM_SAFETY_MODE_SYSTEM_PROMPT,SANDBOX_MODE_PROMPT,CHATUI_SPECIAL_DEFAULT_PERSONA_PROMPT,LIVE_MODE_SYSTEM_PROMPT,PROACTIVE_AGENT_CRON_WOKE_SYSTEM_PROMPT,BACKGROUND_TASK_RESULT_WOKE_SYSTEM_PROMPT
