...
This fork does not operate a user-support queue, chat channel, or on-call
rotation. Development Issues track defects, features, and maintenance; they
are not a helpdesk.

> 本 fork 不运营用户支持队列、聊天频道或值班。开发 Issue 跟踪缺陷、功能与维护，不是客服。
