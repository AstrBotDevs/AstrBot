...
### Déploiement cloud en un clic (RainYun)

Pour les utilisateurs qui souhaitent déployer AstrBot en un clic, le garder en ligne 24 heures sur 24 et ne pas gérer eux-mêmes de serveur, nous recommandons le service de déploiement cloud en un clic de RainYun ☁️ :
...
Vous pouvez nous soutenir via [Afdian](https://afdian.com/a/astrbot_team) ou [nous contacter par e-mail](mailto:community@astrbot.app).
...
| Comptes officiels WeChat | Officielle |
...
Nous avons plus de 15 groupes de discussion. Consultez la page [Communauté](https://docs.astrbot.app/community.html) pour plus de détails.
...
Amis de l'open source ❤️

- [NapNeko/NapCatQQ](https://github.com/NapNeko/NapCatQQ) - L'incroyable framework félin
- [Mai-with-u/MaiBot](https://github.com/Mai-with-u/MaiBot) - La puissante « vie numérique » sur QQ !
...
[![Graphique de l’historique des étoiles du dépôt](https://repostars.dev/api/embed?repo=AstrBotDevs%2FAstrBot&theme=dark)](https://repostars.dev/?repos=AstrBotDevs%2FAstrBot&theme=dark)
