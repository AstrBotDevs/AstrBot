...
- Raise the model image input cap from 32 MiB to 64 MiB. Larger originals are skipped before reading image bytes; accepted inputs still produce images strictly below 512 KiB.
