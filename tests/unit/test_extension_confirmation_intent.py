...
class _FakeContext:
    def __init__(self, cfg: dict | None = None, conversation_manager=None) -> None:
        self._cfg = cfg or {}
...
def _build_main(config: dict | None = None, conversation_manager=None) -> Main:
    main = Main.__new__(Main)
    main.context = _FakeContext(config, conversation_manager=conversation_manager)
    return main
