              ...
              <v-expansion-panels v-model="expandedPanels" multiple>
                ...
                <v-expansion-panel value="subagents">
                  <v-expansion-panel-title>
                    ...
                    <v-chip
                      v-if="
                        Array.isArray(personaForm.subagents) &&
                        personaForm.subagents.length > 0
                      "
                      size="small"
                      color="primary"
                      variant="tonal"
                  ...
                  <v-expansion-panel-text>
                    ...
                    <v-radio-group
                      v-model="subagentSelectValue"
                      class="mt-2"
                      hide-details="true"
                    >
                      <v-radio
                        :label="tm('form.subagentsAllAvailable')"
                        value="0"
                      />
                      <v-radio
                        :label="tm('form.subagentsSelectSpecific')"
                        value="1"
                      />
                    </v-radio-group>

                    <div
                      v-if="subagentSelectValue === '1'"
                      class="mt-3 selected-config-area"
                    >
                      <v-text-field
                        v-model="subagentSearch"
                        :label="tm('form.searchSubagents')"
                        prepend-inner-icon="mdi-magnify"
                        variant="outlined"
                        density="compact"
                        hide-details
                      ...
                      <div
                        ...
                        class="subagents-selection"
                      >
                        <v-virtual-scroll
                          :items="filteredSubagents"
                          height="240"
                          item-height="48"
                        >
                          <template #default="{ item }">
                            ...
                            >
                              <template #prepend>
                                <v-checkbox-btn
                                  :model-value="isSubagentSelected(item.name)"
                      ...
                      <div
                        v-else-if="
                          !loadingSubagents && availableSubagents.length === 0
                        "
                        class="text-center pa-4"
                      >
                        <v-icon size="48" color="grey-lighten-2" class="mb-2">
                      ...
                      <div
                        v-else-if="
                          !loadingSubagents && filteredSubagents.length === 0
                        "
                        class="text-center pa-4"
                      >
                        <v-icon size="48" color="grey-lighten-2" class="mb-2">
                      ...
                      <div class="mt-4">
                        <h4 class="text-subtitle-2 mb-2">
                          ...
                          <span
                            v-if="personaForm.subagents === null"
                            class="text-success"
                          >
                            ({{ tm("form.allSelected") }})
                          </span>
                          <span
                            v-else-if="Array.isArray(personaForm.subagents)"
                          >
                            ({{ personaForm.subagents.length }})
                          </span>
                        </h4>
                        ...
                        >
                          <v-chip
                            v-for="subagentName in personaForm.subagents"
                            :key="subagentName"
                            size="small"
                            color="primary"
                            variant="tonal"
...
export default {
  ...
  methods: {
    ...
    toggleSubagent(subagentName) {
      if (this.personaForm.subagents === null) {
        this.personaForm.subagents = this.availableSubagents
