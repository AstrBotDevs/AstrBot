 ...
 */
export const listMcpResources = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListMcpResourcesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListMcpResourcesResponse, ListMcpResourcesError, ThrowOnError>({
        ...options,
...
/**
 * List resource templates exposed by a connected MCP server
 */
export const listMcpResourceTemplates = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListMcpResourceTemplatesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListMcpResourceTemplatesResponse, ListMcpResourceTemplatesError, ThrowOnError>({
        ...options,
        url: '/api/v1/mcp/resource-templates'
    });
};
 ...
 */
export const listMcpPrompts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListMcpPromptsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListMcpPromptsResponse, ListMcpPromptsError, ThrowOnError>({
        ...options,
...
/**
 * Safely preview a prompt from a connected MCP server
 */
export const previewMcpPrompt = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PreviewMcpPromptData, ThrowOnError>) => {
    return (options?.client ?? client).post<PreviewMcpPromptResponse, PreviewMcpPromptError, ThrowOnError>({
        ...options,
        url: '/api/v1/mcp/prompts/preview'
    });
};

/**
 * Read a text preview or binary metadata from an MCP resource
 */
export const readMcpResource = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReadMcpResourceData, ThrowOnError>) => {
    return (options?.client ?? client).post<ReadMcpResourceResponse, ReadMcpResourceError, ThrowOnError>({
        ...options,
