...
/**
 * Start OpenAI OAuth authorization for a provider source
 */
export const startProviderSourceOpenAioAuth = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StartProviderSourceOpenAioAuthData, ThrowOnError>) => {
    return (options?.client ?? client).post<StartProviderSourceOpenAioAuthResponse, StartProviderSourceOpenAioAuthError, ThrowOnError>({
        ...options,
        url: '/api/v1/provider-sources/openai-oauth/start'
    });
};

/**
 * Complete OpenAI OAuth authorization for a provider source
 */
export const completeProviderSourceOpenAioAuth = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CompleteProviderSourceOpenAioAuthData, ThrowOnError>) => {
    return (options?.client ?? client).post<CompleteProviderSourceOpenAioAuthResponse, CompleteProviderSourceOpenAioAuthError, ThrowOnError>({
        ...options,
        url: '/api/v1/provider-sources/openai-oauth/complete'
    });
};

/**
 * Refresh OpenAI OAuth credentials for a provider source
 */
export const refreshProviderSourceOpenAioAuth = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RefreshProviderSourceOpenAioAuthData, ThrowOnError>) => {
    return (options?.client ?? client).post<RefreshProviderSourceOpenAioAuthResponse, RefreshProviderSourceOpenAioAuthError, ThrowOnError>({
        ...options,
        url: '/api/v1/provider-sources/openai-oauth/refresh'
    });
};

/**
 * Disconnect OpenAI OAuth credentials from a provider source
 */
export const disconnectProviderSourceOpenAioAuth = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DisconnectProviderSourceOpenAioAuthData, ThrowOnError>) => {
    return (options?.client ?? client).post<DisconnectProviderSourceOpenAioAuthResponse, DisconnectProviderSourceOpenAioAuthError, ThrowOnError>({
        ...options,
        url: '/api/v1/provider-sources/openai-oauth/disconnect'
    });
};
