...
/**
 * Get one full WebChat history message
 */
export const getChatMessage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetChatMessageData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetChatMessageResponse, GetChatMessageError, ThrowOnError>({
        ...options,
