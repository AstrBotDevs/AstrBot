...
/**
 * Subscribe to proactive WebChat history updates
 * SSE stream for an owned WebChat session. Emits a history_updated data event
 * on connection and after proactive messages are persisted. Clients should
 * reload history on notification. Events are coalesced for slow readers.
 *
 */
export const subscribeChatSessionHistory = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SubscribeChatSessionHistoryData, ThrowOnError>) => {
    return (options?.client ?? client).get<SubscribeChatSessionHistoryResponse, SubscribeChatSessionHistoryError, ThrowOnError>({
        ...options,
 ...
 */
export const initFileUpload = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<InitFileUploadData, ThrowOnError>) => {
    return (options?.client ?? client).post<InitFileUploadResponse, InitFileUploadError, ThrowOnError>({
        ...options,
 ...
 * Upload a file chunk
 */
export const uploadFileChunk = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UploadFileChunkData, ThrowOnError>) => {
    return (options?.client ?? client).post<UploadFileChunkResponse, UploadFileChunkError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
 ...
 */
export const completeFileUpload = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CompleteFileUploadData, ThrowOnError>) => {
    return (options?.client ?? client).post<CompleteFileUploadResponse, CompleteFileUploadError, ThrowOnError>({
        ...options,
 ...
 */
export const abortFileUpload = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AbortFileUploadData, ThrowOnError>) => {
    return (options?.client ?? client).post<AbortFileUploadResponse, AbortFileUploadError, ThrowOnError>({
        ...options,
 ...
 */
export const statusFileUpload = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StatusFileUploadData, ThrowOnError>) => {
    return (options?.client ?? client).post<StatusFileUploadResponse, StatusFileUploadError, ThrowOnError>({
        ...options,
 ...
 */
export const getConversationFilterOptions = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetConversationFilterOptionsResponse, GetConversationFilterOptionsError, ThrowOnError>({
        ...options,
 ...
 */
export const statusBackupUpload = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StatusBackupUploadData, ThrowOnError>) => {
    return (options?.client ?? client).post<StatusBackupUploadResponse, StatusBackupUploadError, ThrowOnError>({
        ...options,
