...
/**
 * Preview an image referenced by a conversation
 */
export const previewConversationMedia = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PreviewConversationMediaData, ThrowOnError>) => {
    return (options?.client ?? client).get<PreviewConversationMediaResponse, PreviewConversationMediaError, ThrowOnError>({
        ...options,
        url: '/api/v1/conversations/{conversation_id}/media/{media_id}'
    });
};
