...
/**
 * List UMO config overrides
 */
export const listSessionConfigOverrides = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListSessionConfigOverridesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSessionConfigOverridesResponse, ListSessionConfigOverridesError, ThrowOnError>({
        ...options,
        url: '/api/v1/sessions/config-overrides'
    });
};

/**
 * Update or create a UMO config override
 */
export const upsertSessionConfigOverride = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpsertSessionConfigOverrideData, ThrowOnError>) => {
    return (options?.client ?? client).post<UpsertSessionConfigOverrideResponse, UpsertSessionConfigOverrideError, ThrowOnError>({
        ...options,
        url: '/api/v1/sessions/config-overrides'
    });
};
...
/**
 * Delete one or more UMO config overrides
 */
export const deleteSessionConfigOverride = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteSessionConfigOverrideData, ThrowOnError>) => {
    return (options?.client ?? client).post<DeleteSessionConfigOverrideResponse, DeleteSessionConfigOverrideError, ThrowOnError>({
        ...options,
        url: '/api/v1/sessions/config-overrides/delete'
    });
};

/**
 * Update UMO aliases used as session remarks
 */
export const upsertSessionAlias = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpsertSessionAliasData, ThrowOnError>) => {
    return (options?.client ?? client).post<UpsertSessionAliasResponse, UpsertSessionAliasError, ThrowOnError>({
        ...options,
        url: '/api/v1/sessions/aliases'
    });
};
...
/**
 * List workspace files for one UMO
 */
export const listUmoWorkspaceFiles = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListUmoWorkspaceFilesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListUmoWorkspaceFilesResponse, ListUmoWorkspaceFilesError, ThrowOnError>({
        ...options,
        url: '/api/v1/workspaces/by-umo'
    });
};
