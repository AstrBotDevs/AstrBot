...
/**
 * List knowledge base import tasks
 */
export const listKnowledgeTasks = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListKnowledgeTasksData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListKnowledgeTasksResponse, ListKnowledgeTasksError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/tasks'
    });
};
