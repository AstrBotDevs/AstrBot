...
/**
 * Preview a table file headers and sample rows
 */
export const previewKnowledgeTable = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PreviewKnowledgeTableData, ThrowOnError>) => {
    return (options?.client ?? client).post<PreviewKnowledgeTableResponse, PreviewKnowledgeTableError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
        ...
        url: '/api/v1/knowledge-bases/{kb_id}/documents/preview-table'
    });
};

/**
 * Import a table file with column configuration
 */
export const importKnowledgeTable = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ImportKnowledgeTableData, ThrowOnError>) => {
    return (options?.client ?? client).post<ImportKnowledgeTableResponse, ImportKnowledgeTableError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
        ...
        url: '/api/v1/knowledge-bases/{kb_id}/documents/import-table'
    });
};
