...
/**
 * Get pinned extension names
 */
export const getPinnedExtensions = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetPinnedExtensionsResponse, GetPinnedExtensionsError, ThrowOnError>({
        ...options,
        url: '/api/v1/plugins/preferences/pinned'
    });
};

/**
 * Update pinned extension names
 */
export const updatePinnedExtensions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdatePinnedExtensionsData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdatePinnedExtensionsResponse, UpdatePinnedExtensionsError, ThrowOnError>({
        ...options,
        url: '/api/v1/plugins/preferences/pinned'
    });
};
