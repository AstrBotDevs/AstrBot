...
export function getProviderIcon(type) {
  const icons = {
    ...
    'stepfun': 'https://cdn.jsdelivr.net/npm/@lobehub/icons-static-svg@latest/icons/stepfun.svg',
    'stepfun-step-plan': 'https://cdn.jsdelivr.net/npm/@lobehub/icons-static-svg@latest/icons/stepfun.svg',
